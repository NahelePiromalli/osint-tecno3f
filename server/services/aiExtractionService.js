 ...
 */
export async function analyzeCompanyWithGemini(companyName, scrapedData = {}, searchData = {}) {
...
ESTRUCTURA JSON REQUERIDA:
{
  ...
  "whoBuys": "Quiénes son los compradores o clientes de ${cleanComp} verificados en su texto web",
  ...
  "executiveSummary": "Síntesis ejecutiva de 2 párrafos basada 100% en los hechos extraídos de ${cleanComp}",
  "strengths": ["Fortaleza real 1 verificada en el texto", "Fortaleza real 2 verificada"],
  "weaknesses": ["Debilidad o brecha identificada (ej: falta de cotización automática)"],
